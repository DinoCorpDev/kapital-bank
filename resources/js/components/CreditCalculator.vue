        ...
        <div class="welcome-wrap">
          <span class="welcome-name">
            <template v-if="isLoggedIn">
              ¡Hola, <b>{{ authUser.name }}!</b>
            </template>
            <template v-else>¡Hola!</template>
          </span>
        </div>
...
import { CalendarIcon, ClientTypeIcon, CreditTypeIcon, LeftArrowIcon } from '../icons';
...
export default {
  ...
  computed: {
    ...mapState('auth', ['authUser', 'isLoggedIn']),
    firstName() {
  ...
  methods: {
    ...mapActions('credit', ['setCreditInfo']),
    generateDues(count) {
